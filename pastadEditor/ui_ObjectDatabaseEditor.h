/********************************************************************************
** Form generated from reading UI file 'ObjectDatabaseEditorg10988.ui'
**
...
#ifndef OBJECTDATABASEEDITORG10988_H
#define OBJECTDATABASEEDITORG10988_H
...
public:
    ...
    {
        form_EditObjectDatabase->setWindowTitle(QApplication::translate("form_EditObjectDatabase", "Form", 0));
        pb_objectdb_new->setText(QApplication::translate("form_EditObjectDatabase", "New", 0));
        pb_objectdb_remove->setText(QApplication::translate("form_EditObjectDatabase", "Remove", 0));
        pb_objectdb_apply->setText(QApplication::translate("form_EditObjectDatabase", "Apply", 0));
        pb_objectdb_path->setText(QApplication::translate("form_EditObjectDatabase", "Set", 0));
        pb_objectdb_icon_path->setText(QApplication::translate("form_EditObjectDatabase", "Set", 0));
        lbl_objectdb_path->setText(QApplication::translate("form_EditObjectDatabase", "Not set", 0));
        lbl_objectdb_icon_path->setText(QApplication::translate("form_EditObjectDatabase", "Not set", 0));
        lbl_objectdb_path_3->setText(QApplication::translate("form_EditObjectDatabase", "Name", 0));
        lbl_objectdb_path_4->setText(QApplication::translate("form_EditObjectDatabase", "Path", 0));
        lbl_objectdb_path_5->setText(QApplication::translate("form_EditObjectDatabase", "Icon path", 0));
        lbl_objectdb_path_6->setText(QApplication::translate("form_EditObjectDatabase", "Description", 0));
        lbl_test->setText(QApplication::translate("form_EditObjectDatabase", "llllabel", 0));
    } // retranslateUi
...
#endif // OBJECTDATABASEEDITORG10988_H
