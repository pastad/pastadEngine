...
bool EngineGUI::initialize()
{
  ...
  m_txt_refresh_shader = GUI::addText();
  ...
  m_tb_shadow_standard = GUI::addButton();
  ...
  m_txt_shadow_standard = GUI::addText();
