/********************************************************************************
** Form generated from reading UI file 'SuccessorSelector.ui'
**
...
#ifndef UI_SUCCESSORSELECTOR_H
#define UI_SUCCESSORSELECTOR_H
...
public:
    ...
    {
        form_EditSuccessors->setWindowTitle(QApplication::translate("form_EditSuccessors", "Form", Q_NULLPTR));
        pb_ss_add->setText(QApplication::translate("form_EditSuccessors", ">", Q_NULLPTR));
        pb_ss_remove->setText(QApplication::translate("form_EditSuccessors", "<", Q_NULLPTR));
    } // retranslateUi
